...
export const routes: Routes = [
  ...
  { path: 'upcoming-features', loadComponent: () => import('./features/feature-log/feature-log.component').then(m => m.FeatureLogComponent), title: 'OneSpace — Features Log' },
  {
    ...
    children: [
      ...
      { path: 'nanna', loadComponent: () => import('./features/expense-tracker/pages/nanna-expenses/nanna-expenses.component').then(m => m.NannaExpensesComponent), title: 'OneSpace — Rent Logs' },
    ]
  },
  { path: '**', redirectTo: '' },
];
